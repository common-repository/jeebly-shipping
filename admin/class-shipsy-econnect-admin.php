...
class Shipsy_Econnect_Admin {
	...
	public function enqueue_scripts() {
		...
		if ( in_array( $page, $valid_pages, true ) || in_array( $post, $valid_posts, true ) ) {
			...
			wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/shipsy-econnect-admin.js', array( 'jquery' ), $this->version, false );
			wp_localize_script(
				$this->plugin_name,
				'localized_data',
				array(
					'ajaxurl'            => admin_url( 'admin-ajax.php' ),
					'ajax-admin-post'    => admin_url( 'admin-post.php' ),
	...
	public function wpse_73623_render_hidden_page() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/partials/ec-manage.php'; // included template file.
	}
	...
	public function wpse_73622_render_hidden_page() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/partials/ec-sync-form.php'; // included template file.
	}
	...
	public function shipsy_vseries() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/partials/ec-vseries.php'; // included template file.
	}
	...
	public function shipsy_setup() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/partials/ec-setup.php'; // included template file.
	}
	...
	public function shipsy_config() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/partials/ec-config.php'; // included template file.
	}
	...
	public function shipsy_sync_result() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/partials/ec-sync-result.php'; // included template file.
	}
	...
	public function ajax_endpoint_url_helper() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/apis/endpoint-helper-api.php';
	}
	...
	public function ajax_all_addresses_helper() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/apis/addresses-helper-api.php';
	}
	...
	public function ajax_shipping_address_helper() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/apis/shipping-address-helper-api.php';
	}
	...
	public function ajax_shipsy_download_label() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/apis/shipping-label-download-api.php';
	}
	...
	public function shipsy_sync_submit() {
		include_once SHIPSY_ECONNECT_PATH . 'admin/apis/softdata-upload-api.php';
	}
	...
	public function wc_add_column( $columns ) {
		...
		if ( shipsy_get_download_label_option() ) {
